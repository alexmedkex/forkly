...
GETH_ARGS='--datadir /qdata/dd --istanbul.blockperiod 5 --mine --minerthreads 1 --syncmode full --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --nodiscover --password /qdata/passwords.txt --unlock 0 --rpccorsdomain http://localhost:3003 --targetgaslimit 804247552'
