...
@injectable()
export class LCPresentationDiscrepanciesRejectedByIssuingBankProcessor extends LCPresentationProcessorBase
  implements ILCPresentationTransitionStateProcessor {
  public state = LCPresentationContractStatus.DiscrepanciesRejectedByIssuingBank

  private presentationStatus = LCPresentationStatus.DiscrepanciesRejectedByIssuingBank
  ...
  constructor(
    ...
    this.handlers.set(LCPresentationRole.Applicant, this.notifyStateChange.bind(this))
