...
@injectable()
export class LCPresentationDiscrepanciesAcceptedByIssuingBankProcessor extends LCPresentationProcessorBase
  implements ILCPresentationTransitionStateProcessor {
  public state = LCPresentationContractStatus.DiscrepanciesAcceptedByIssuingBank

  private presentationStatus = LCPresentationStatus.DiscrepanciesAcceptedByIssuingBank
