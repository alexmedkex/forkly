...
@injectable()
export class LCPresentationDiscrepantByNominatedBankProcessor extends LCPresentationProcessorBase
  implements ILCPresentationTransitionStateProcessor {
  public state = LCPresentationContractStatus.DocumentsDiscrepantByNominatedBank
  ...
  constructor(
    ...
    this.logger = getLogger('LCPresentationDiscrepantByNominatedBankProcessor')
