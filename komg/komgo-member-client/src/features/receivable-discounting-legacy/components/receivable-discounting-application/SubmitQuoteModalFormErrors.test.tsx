...
describe('FormErrors component', () => {
  ...
  it('should not find error component if there are not errors', () => {
    const wrapper = shallow(<SubmitQuoteModalFormErrors {...defaultProps} />)
  ...
  it('should find error component if there are errors', () => {
    ...
    const wrapper = shallow(<SubmitQuoteModalFormErrors {...defaultProps} formik={formik} />)
  ...
  it('should match snapshot', () => {
    ...
    const tree = renderer.create(<SubmitQuoteModalFormErrors {...defaultProps} formik={formik} />).toJSON()
