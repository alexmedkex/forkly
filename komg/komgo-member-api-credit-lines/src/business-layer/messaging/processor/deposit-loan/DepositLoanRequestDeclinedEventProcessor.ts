...
import { IDepositLoanRequestPayload, IDepositLoanRequestMessage } from '../../messages/IDepositLoanMessage'
import { MessageType } from '../../MessageTypes'
import { IEventProcessor } from '../IEventProcessor'

@injectable()
export default class DepositLoanRequestDeclinedEventProcessor
  ...
  async processMessage(messageData: IDepositLoanRequestMessage<IDepositLoanRequestPayload>): Promise<boolean> {
    ...
    return this.depositLoanRequestService.requestDeclined(request)
  }
