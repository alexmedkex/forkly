...
export class NotificationClient {
  ...
  constructor(
    @inject(TYPES.NotificationManagerClient) private readonly notificationManager: NotificationManager,
  ...
  public async sendNotification(notification: INotificationCreateRequest): Promise<void> {
    try {
      ...
      // notfManger has its own version of axios so we can' use axios-retry
